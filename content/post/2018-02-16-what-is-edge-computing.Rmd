...
The routers nodes between wireless and wired networks, aptly named the "Edge", are a natural focal point in the discourse. Wireless connections, while making it easy to deploy sensors en masse, do not offer the same reliability and transmission capacity as cables. Three broad use cases in particular suffer from a vertical sensor-to-cloud architecture:
